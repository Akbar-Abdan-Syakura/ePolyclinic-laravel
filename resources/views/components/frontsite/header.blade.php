...
<nav x-data="{ navbarMobileOpen: false }" class="bg-white">
    <div class="max-w-7xl mx-auto px-4 lg:px-14 pt-6 lg:py-10">
        <div class="flex justify-between h-16">
            ...
            <div class="-mr-2 flex items-center lg:hidden">
                <button type="button"
                    class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#DA1B4F]"
                    ...
                    <div>
                        <button type="button" class="bg-white rounded-full flex text-sm focus:outline-none"
                            ...
                            <img class="h-12 w-12 rounded-full ring-1 ring-offset-4 ring-[#DA1B4F]"
                                src="{{ ('/assets/frontsite/images/authenticated-user.svg') }}" alt="User Profile" />
                        </button>
                    </div>
    ...
    <div class="lg:hidden" id="mobile-menu" x-show="navbarMobileOpen">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <!--
            Active Link: "bg-indigo-50 border-[#DA1B4F] text-[#1E2B4F]",
