...
{{-- set title --}}
@section('title', 'Edit - Poli Services')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Edit Poli Services</h3>
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('backsite.dashboard.index') }}">Dashboard</a>
                            </li>
                            <li class="breadcrumb-item"><a href="{{ route('backsite.poli.index') }}">Poli Services</a>
                            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('backsite.poli.update',
                                    [$poli->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <h4 class="form-section"><i class="fa fa-edit"></i>Form Poli Services</h4>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="name" name="name" class="form-control"
                                                        ...
                                                        value="{{ old('name', isset($poli) ? $poli->name : '') }}"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="price" name="price" class="form-control"
                                                        ...
                                                        value="{{ old('price', isset($poli) ? $poli->price : '') }}"
                                                        autocomplete="off"
                                        ...
                                        <div class="form-actions text-right">
                                            <a href="{{ route('backsite.poli.index') }}" style="width:120px;"
