                                ...
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal"
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-md-3 label-control" for="ppn">PPN <code
                                                        style="color:red;">required</code></label>
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="ppn" name="ppn" class="form-control"
                                                        placeholder="example ppn 10000"
                                                        value="{{ old('ppn', isset($config_payment) ? $config_payment->ppn : '') }}"
                                                        autocomplete="off"
                                                        data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'autoGroup': true, 'digits': 0, 'digitsOptional': 0, 'prefix': '', 'placeholder': '0'"
                                                        required>

                                                    @if($errors->has('ppn'))
                                                    <p style="font-style: bold; color: red;">{{ $errors->first('ppn') }}
                                                    </p>
                                                    @endif
                                                </div>
                                            </div>
