                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('backsite.doctor.index') }}">Role</a>
                            </li>
                        ...
                        <div class="card">
                            ...
                            <div class="card-content collpase show">
                                <div class="card-body">
                                    ...
                                    <form class="form form-horizontal" action="{{ route('backsite.doctor.update',
                                        [$doctor->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <select name="user_id" id="user_id" class="form-control select2"
                                                        ...
                                                        <option value="{{ $user_item->id }}" {{ $doctor->user_id ==
                                                            $user_item->id ? 'selected' : '' }}>
                                                            {{ $user_item->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div
                                                class="form-group row {{ $errors->has('poli_id') ? 'has-error' : '' }}">
                                                <label class="col-md-3 label-control">Poli Services <code
                                                        style="color:red;">required</code></label>
                                                <div class="col-md-9 mx-auto">
                                                    <select name="poli_id" id="poli_id" class="form-control select2"
                                                        required>
                                                        <option value="{{ '' }}" disabled selected>Choose</option>
                                                        @foreach($poli as $key => $poli_item)
                                                        <option value="{{ $poli_item->id }}" {{ $doctor->poli_id
                                                            == $poli_item->id ? 'selected' : ''
                                                            }}>
                                                            {{ $poli_item->name }}
                                                        </option>
                                                        @endforeach
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <input type="text" id="fee" name="fee" class="form-control"
                                                        ...
                                                        value="{{ old('fee', isset($doctor) ? $doctor->fee : '') }}"
                                                        autocomplete="off"
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    ...
                                                    <p class="text-muted"><small class="text-danger">Hanya dapat
                                                            ...
                                                            JPEG, SVG, PNG dengan maksimal ukuran file 10 MB</small></p>
