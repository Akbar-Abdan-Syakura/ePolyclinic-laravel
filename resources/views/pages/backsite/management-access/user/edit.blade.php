                ...
                <div class="row breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper col-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('backsite.user.index') }}">User</a>
                            </li>
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    ...
                                                    <select name="role[]" id="role" class="form-control select2-full-bg"
                                                        ...
                                                        <option value="{{ $id }}" {{ (in_array($id, old('role', [])) ||
                                                            isset($user) && $user->role->contains($id)) ? 'selected' :
                                                            '' }}>{{ $role }}</option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div
                                                ...
                                                <div class="col-md-9 mx-auto">
                                                    <select name="type_user_id" id="type_user_id"
                                                        ...
                                                        <option value="{{ $type_user_item->id }}" {{ $type_user_item->id
