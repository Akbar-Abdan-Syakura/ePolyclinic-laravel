...
<main class="min-h-screen">
    ...
    <section class="relative mt-12">
        ...
        <div class="hidden lg:block lg:absolute lg:z-10 lg:top-0 lg:right-0" aria-hidden="true">
            ...
            <div
                ...
                <p class="text-xs text-[#AFAEC3] mt-1">Poli Jantung Umum</h1>
                    <span
                ...
                <div class="lg:col-span-6">
                    ...
                    <h1>
                        <div class="flex items-center">
                            <span class="text-white text-xs sm:text-sm font-medium bg-[#55CA63] rounded-full px-8 py-2">
                                New
                            </span>
                            <span
                        ...
                        <span class="mt-6 block text-4xl font-semibold sm:text-5xl">
                            <span class="block text-[#1E2B4F] leading-normal">Find Your Doctor <br />
                                For Your Better Health</span>
                        </span>
                    </h1>
                    <!-- End Label New -->
    ...
    <section class="mt-32 bg-[#F9FBFC]">
        <div class="mx-auto max-w-7xl px-4 lg:px-14 py-16">
            <h3 class="text-2xl font-semibold">Explore Popular Categories</h3>
