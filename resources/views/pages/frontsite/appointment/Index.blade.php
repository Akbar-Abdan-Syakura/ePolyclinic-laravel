...
<div class="min-h-screen">
    <div class="lg:max-w-7xl lg:flex items-center mx-auto px-4 lg:px-14 pt-6 py-20 lg:py-24 gap-x-24">
        ...
        <div class="lg:w-5/12 lg:border-r h-72 lg:h-[30rem] flex flex-col items-center justify-center text-center">
            ...
            <div class="text-[#AFAEC3] mt-1">Poli Gigi</div>
            ...
            <form action="" class="mt-8 space-y-5">
                <label class="block">
                    <select name="topic" id="topic"
                        class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#DA1B4F]"
                ...
                <div class="grid">
                    <a href="{{ route('payment.index') }}"
                        class="bg-[#DA1B4F] rounded-full mt-5 text-white text-lg font-medium px-10 py-3 text-center">Continue</a>
                </div>
            </form>
        </div>
    </div>
