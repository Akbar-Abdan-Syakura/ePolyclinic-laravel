            ...
            <div class="flex flex-col justify-center h-full px-24 pt-10 pb-20">
                <div class="relative">
                    ...
                    <p class="text-2xl leading-loose">
                        ePolyclinic telah membantu saya terhubung dengan dokter yang professional dan memberikan dampak
                        yang sangat besar untuk penyembuhan penyakit yang saya derita
                    </p>
